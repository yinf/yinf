...
我们的主要用户群体均为付费用户，对于系统的稳定性要求会更加严格。辅导老师、主讲老师和教研老师依赖我们的系统去传递知识、传递快乐，学生依赖我们的系统获得成长，短暂的服务不可用都会给大量的家庭带来影响。更困难的是，猿辅导的业务规模每年以数倍增速进行扩张，系统设计之初的冗余很快就会被高增速打满。可用性、可扩展性是我们在系统设计上最优先考虑的要素。
